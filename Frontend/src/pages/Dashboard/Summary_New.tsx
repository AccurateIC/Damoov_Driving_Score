  ...
  return (
    <div className="bg-gray-50 min-h-screen py-8 px-4 md:px-12 font-inter">
      ...
      <div className="mb-2 text-xs text-gray-400">
        Dashboard &gt; <span className="font-semibold text-gray-800">Summary</span>
      </div>

      {/* Tabs */}
      <div className="flex gap-8 mb-8 border-b border-gray-200">
        {/* <button className="text-base font-medium pb-3 text-blue-600 border-b-2 border-blue-600">
          Performance
        </button>
        <button className="text-base font-medium pb-3 text-gray-400">Eco Driving</button>
        <button className="text-base font-medium pb-3 text-gray-400">Safe Driving</button> */}
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-sm p-7">
        <div className="flex flex-wrap items-center justify-between mb-4">
          <div>
            <label className="text-gray-500 font-medium mr-4">Performance for</label>
            <select className="px-3 py-1 rounded border bg-gray-50 text-sm text-gray-700">
              <option value="trips">Trips</option>
            </select>
          </div>
          <div>
            <label className="text-gray-500 font-medium mr-3">Last Year</label>
            <select className="px-3 py-1 rounded border bg-gray-50 text-sm text-gray-700">
...
//         <div className="flex flex-wrap items-center justify-between mb-4">
//           <div>
//             <label className="text-gray-500 font-medium mr-4">
//               Performance for
//             </label>
//             <select className="px-3 py-1 rounded border bg-gray-50 text-sm text-gray-700">
//               <option value="trips">Trips</option>
