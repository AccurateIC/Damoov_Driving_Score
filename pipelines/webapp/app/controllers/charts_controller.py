...
from ...db_queries import load_df, get_safety_graph_data, get_mileage_graph_data, get_engine
from ..utils.helpers import get_time_range, normalize_timestamp
...
def mileage_daily():
    ...
    filtered_df["date"] = filtered_df["timestamp"].dt.date
    daily_mileage = (
        filtered_df.groupby("date")["trip_distance_used"]
        .sum()
        .reset_index()
        .dropna()
    )
